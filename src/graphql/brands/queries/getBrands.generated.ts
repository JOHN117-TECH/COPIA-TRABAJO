...
export type GetBrandsQueryVariables = Types.Exact<{
  ...
  isVisible?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;


export type GetBrandsQuery = { __typename?: 'Query', brands?: { __typename?: 'BrandNodeConnection', edges: Array<{ __typename?: 'BrandNodeEdge', node?: { __typename?: 'BrandNode', id: string, title: string, slug: string, brandType?: Types.BrandBrandType | null, reverseLogoSmall?: string | null, imageThumbMedium?: string | null, description?: string | null, content?: string | null, externalLink?: string | null } | null } | null> } | null };


export const GetBrandsDocument = gql`
    query getBrands($instanceIds: [ID], $isVisible: Boolean) {
