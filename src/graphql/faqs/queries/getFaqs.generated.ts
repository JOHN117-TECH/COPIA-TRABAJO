...
export type GetFaQsQuery = { __typename?: 'Query', faqs?: { __typename?: 'FAQNodeConnection', edges: Array<{ __typename?: 'FAQNodeEdge', node?: { __typename?: 'FAQNode', id: string, question: string, answer: string } | null } | null> } | null };


export const GetFaQsDocument = gql`
    query getFAQs($instances: [ID]) {
