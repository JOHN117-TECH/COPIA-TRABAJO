...
export type Patterns_IsNewQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type Patterns_IsNewQuery = { __typename?: 'Query', patterns?: { __typename: 'PatternNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'PatternNodeEdge', node?: { __typename: 'PatternNode', imageThumbSmall?: string | null, products?: { __typename: 'ProductNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'ProductNodeEdge', node?: { __typename: 'ProductNode', id: string, code: string, color: string, predominantColors: Array<string>, imageThumbSmall?: string | null, isNew: boolean } | null } | null> } | null } | null } | null> } | null };


export const Patterns_IsNewDocument = gql`
    query patterns_isNew {
  patterns(saleable: true) {
    totalCount
    edges {
      node {
        imageThumbSmall
...
/**
 * __usePatterns_IsNewQuery__
 *
 * To run a query within a React component, call `usePatterns_IsNewQuery` and pass it any options that fit your needs.
 * When your component renders, `usePatterns_IsNewQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function usePatterns_IsNewQuery(baseOptions?: Apollo.QueryHookOptions<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>(Patterns_IsNewDocument, options);
      }
export function usePatterns_IsNewLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>(Patterns_IsNewDocument, options);
        }
export function usePatterns_IsNewSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>(Patterns_IsNewDocument, options);
        }
export type Patterns_IsNewQueryHookResult = ReturnType<typeof usePatterns_IsNewQuery>;
export type Patterns_IsNewLazyQueryHookResult = ReturnType<typeof usePatterns_IsNewLazyQuery>;
export type Patterns_IsNewSuspenseQueryHookResult = ReturnType<typeof usePatterns_IsNewSuspenseQuery>;
export type Patterns_IsNewQueryResult = Apollo.QueryResult<Patterns_IsNewQuery, Patterns_IsNewQueryVariables>;