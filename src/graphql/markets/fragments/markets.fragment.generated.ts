...
export type MarketFieldsFragment = { __typename?: 'MarketNode', id: string, slug: string, name: string, description: string, imageThumbMedium?: string | null, sectors: { __typename?: 'SectorNodeConnection', edges: Array<{ __typename?: 'SectorNodeEdge', node?: { __typename?: 'SectorNode', id: string, name: string, slug: string, patternSet?: { __typename?: 'PatternNodeConnection', totalCount?: number | null } | null } | null } | null> } };

export const MarketFieldsFragmentDoc = gql`
    fragment MarketFields on MarketNode {
  id
  slug
  name
  description
  ...
  sectors {
    edges {
      node {
        ...
        name
        slug
        patternSet(products_Instances: $instanceIds, saleable: $saleable) {
          totalCount
        }
      }
    }
