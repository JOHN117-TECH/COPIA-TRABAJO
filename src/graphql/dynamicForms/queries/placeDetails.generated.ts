...
export type PlaceDetailsQueryVariables = Types.Exact<{
  instanceId: Types.Scalars['ID']['input'];
  placeId: Types.Scalars['String']['input'];
}>;


export type PlaceDetailsQuery = { __typename?: 'Query', getPlaceDetails?: { __typename?: 'PlaceDetails', city?: string | null, country?: string | null, state?: string | null, fullAddress?: string | null, postalCode?: string | null } | null };


export const PlaceDetailsDocument = gql`
    query placeDetails($instanceId: ID!, $placeId: String!) {
  getPlaceDetails(placeId: $placeId, instanceId: $instanceId) {
    city
    country
    state
    fullAddress
 ...
 * });
 */
export function usePlaceDetailsQuery(baseOptions: Apollo.QueryHookOptions<PlaceDetailsQuery, PlaceDetailsQueryVariables> & ({ variables: PlaceDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function usePlaceDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<PlaceDetailsQuery, PlaceDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<PlaceDetailsQuery, PlaceDetailsQueryVariables>(PlaceDetailsDocument, options);
        }
...
export type PlaceDetailsSuspenseQueryHookResult = ReturnType<typeof usePlaceDetailsSuspenseQuery>;
