...
export type GetDynamicFormQueryVariables = Types.Exact<{
  id: Types.Scalars['ID']['input'];
}>;


export type GetDynamicFormQuery = { __typename?: 'Query', contactForm?: { __typename?: 'ContactFormNode', id: string, title: string, description: string, active: boolean, fields?: { __typename?: 'ContactFormFieldNodeConnection', edges: Array<{ __typename?: 'ContactFormFieldNodeEdge', node?: { __typename?: 'ContactFormFieldNode', id: string, name: string, label: string, placeholder: string, fieldType: Types.FormFieldFieldType, required: boolean, order: number, width: Types.FormFieldWidth, form: { __typename?: 'ContactFormNode', id: string }, dependsOn?: { __typename?: 'ContactFormFieldNode', id: string, name: string, label: string } | null, options?: { __typename?: 'ContactFormFieldOptionNodeConnection', edges: Array<{ __typename?: 'ContactFormFieldOptionNodeEdge', node?: { __typename?: 'ContactFormFieldOptionNode', label: string, value: string, order: number, field: { __typename?: 'ContactFormFieldNode', id: string } } | null } | null> } | null } | null } | null> } | null } | null };


export const GetDynamicFormDocument = gql`
...
/**
 * __useGetDynamicFormQuery__
 *
 * To run a query within a React component, call `useGetDynamicFormQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDynamicFormQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useGetDynamicFormQuery(baseOptions: Apollo.QueryHookOptions<GetDynamicFormQuery, GetDynamicFormQueryVariables> & ({ variables: GetDynamicFormQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDynamicFormQuery, GetDynamicFormQueryVariables>(GetDynamicFormDocument, options);
      }
export function useGetDynamicFormLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDynamicFormQuery, GetDynamicFormQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDynamicFormQuery, GetDynamicFormQueryVariables>(GetDynamicFormDocument, options);
        }
export function useGetDynamicFormSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDynamicFormQuery, GetDynamicFormQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetDynamicFormQuery, GetDynamicFormQueryVariables>(GetDynamicFormDocument, options);
        }
export type GetDynamicFormQueryHookResult = ReturnType<typeof useGetDynamicFormQuery>;
export type GetDynamicFormLazyQueryHookResult = ReturnType<typeof useGetDynamicFormLazyQuery>;
export type GetDynamicFormSuspenseQueryHookResult = ReturnType<typeof useGetDynamicFormSuspenseQuery>;
export type GetDynamicFormQueryResult = Apollo.QueryResult<GetDynamicFormQuery, GetDynamicFormQueryVariables>;