...
export type GetSocialMediaQueryVariables = Types.Exact<{
  instanceId: Types.Scalars['ID']['input'];
}>;


export type GetSocialMediaQuery = { __typename?: 'Query', instance?: { __typename?: 'InstanceNode', id: string, facebookUrl: string, instagramUrl: string, linkedinUrl: string } | null };


export const GetSocialMediaDocument = gql`
    query getSocialMedia($instanceId: ID!) {
 ...
 *
 * To run a query within a React component, call `useGetSocialMediaQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSocialMediaQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useGetSocialMediaQuery(baseOptions: Apollo.QueryHookOptions<GetSocialMediaQuery, GetSocialMediaQueryVariables> & ({ variables: GetSocialMediaQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSocialMediaQuery, GetSocialMediaQueryVariables>(GetSocialMediaDocument, options);
      }
export function useGetSocialMediaLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSocialMediaQuery, GetSocialMediaQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSocialMediaQuery, GetSocialMediaQueryVariables>(GetSocialMediaDocument, options);
        }
export function useGetSocialMediaSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSocialMediaQuery, GetSocialMediaQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetSocialMediaQuery, GetSocialMediaQueryVariables>(GetSocialMediaDocument, options);
        }
export type GetSocialMediaQueryHookResult = ReturnType<typeof useGetSocialMediaQuery>;
export type GetSocialMediaLazyQueryHookResult = ReturnType<typeof useGetSocialMediaLazyQuery>;
export type GetSocialMediaSuspenseQueryHookResult = ReturnType<typeof useGetSocialMediaSuspenseQuery>;
export type GetSocialMediaQueryResult = Apollo.QueryResult<GetSocialMediaQuery, GetSocialMediaQueryVariables>;