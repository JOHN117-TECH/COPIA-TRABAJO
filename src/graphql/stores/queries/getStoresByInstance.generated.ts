...
export type GetStoresByInstanceQueryVariables = Types.Exact<{
  instanceId?: Types.InputMaybe<Types.Scalars['ID']['input']>;
  active?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;


export type GetStoresByInstanceQuery = { __typename?: 'Query', stores?: { __typename: 'StoreNodeConnection', edges: Array<{ __typename: 'StoreNodeEdge', node?: { __typename: 'StoreNode', id: string, name: string, address: string, phoneNumbers?: string | null, email?: string | null, latitude: number, longitude: number, website?: string | null, active: boolean, city: { __typename: 'CityNode', id: string, name: string, country: { __typename: 'CountryNode', id: string, name: string } } } | null } | null> } | null };


export const GetStoresByInstanceDocument = gql`
    query getStoresByInstance($instanceId: ID, $active: Boolean) {
...
/**
 * __useGetStoresByInstanceQuery__
 *
 * To run a query within a React component, call `useGetStoresByInstanceQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetStoresByInstanceQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useGetStoresByInstanceQuery(baseOptions?: Apollo.QueryHookOptions<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>(GetStoresByInstanceDocument, options);
      }
export function useGetStoresByInstanceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>(GetStoresByInstanceDocument, options);
        }
export function useGetStoresByInstanceSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>(GetStoresByInstanceDocument, options);
        }
export type GetStoresByInstanceQueryHookResult = ReturnType<typeof useGetStoresByInstanceQuery>;
export type GetStoresByInstanceLazyQueryHookResult = ReturnType<typeof useGetStoresByInstanceLazyQuery>;
export type GetStoresByInstanceSuspenseQueryHookResult = ReturnType<typeof useGetStoresByInstanceSuspenseQuery>;
export type GetStoresByInstanceQueryResult = Apollo.QueryResult<GetStoresByInstanceQuery, GetStoresByInstanceQueryVariables>;