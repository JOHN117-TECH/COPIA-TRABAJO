...
export type Create_UserMutationVariables = Types.Exact<{
  firstName: Types.Scalars['String']['input'];
  lastName: Types.Scalars['String']['input'];
  email: Types.Scalars['String']['input'];
  password: Types.Scalars['String']['input'];
  instanceId: Types.Scalars['ID']['input'];
  jobTitle: Types.Scalars['String']['input'];
  phone: Types.Scalars['String']['input'];
  company: Types.Scalars['String']['input'];
  termsAndConditions: Types.Scalars['Boolean']['input'];
  newsLatest?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
  position: Types.Scalars['String']['input'];
}>;


export type Create_UserMutation = { __typename?: 'Mutation', createUserForNewWeb?: { __typename?: 'CreateUserForNewWeb', userId?: string | null, ok?: boolean | null } | null };


export const Create_UserDocument = gql`
    mutation create_user($firstName: String!, $lastName: String!, $email: String!, $password: String!, $instanceId: ID!, $jobTitle: String!, $phone: String!, $company: String!, $termsAndConditions: Boolean!, $newsLatest: Boolean, $position: String!) {
  createUserForNewWeb(
    firstName: $firstName
    lastName: $lastName
    email: $email
    ...
    phone: $phone
    company: $company
    acceptTerms: $termsAndConditions
    positionArea: $position
    receiveNews: $newsLatest
  ) {
    userId
    ok
  }
 ...
 *      newsLatest: // value for 'newsLatest'
