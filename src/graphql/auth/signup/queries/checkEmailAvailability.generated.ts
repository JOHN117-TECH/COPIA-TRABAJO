...
export type CheckEmailAvailabilityQueryVariables = Types.Exact<{
  ...
  geographicInstanceId: Types.Scalars['ID']['input'];
}>;


export type CheckEmailAvailabilityQuery = { __typename?: 'Query', isEmailAvailable?: { __typename?: 'EmailAvailabilityType', status?: boolean | null } | null };


export const CheckEmailAvailabilityDocument = gql`
    query checkEmailAvailability($email: String!, $geographicInstanceId: ID!) {
  isEmailAvailable(email: $email, instanceId: $geographicInstanceId) {
    status
  }
}
    `;
 ...
 *      geographicInstanceId: // value for 'geographicInstanceId'
 *   },
 * });
 */
export function useCheckEmailAvailabilityQuery(baseOptions: Apollo.QueryHookOptions<CheckEmailAvailabilityQuery, CheckEmailAvailabilityQueryVariables> & ({ variables: CheckEmailAvailabilityQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useCheckEmailAvailabilitySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<CheckEmailAvailabilityQuery, CheckEmailAvailabilityQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<CheckEmailAvailabilityQuery, CheckEmailAvailabilityQueryVariables>(CheckEmailAvailabilityDocument, options);
        }
...
export type CheckEmailAvailabilitySuspenseQueryHookResult = ReturnType<typeof useCheckEmailAvailabilitySuspenseQuery>;
