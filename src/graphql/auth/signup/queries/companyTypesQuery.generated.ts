...
export type CompanyTypesQueryQueryVariables = Types.Exact<{
  instanceIds: Array<Types.InputMaybe<Types.Scalars['ID']['input']>> | Types.InputMaybe<Types.Scalars['ID']['input']>;
}>;


export type CompanyTypesQueryQuery = { __typename?: 'Query', companyTypes?: { __typename: 'CompanyTypeNodeConnection', edges: Array<{ __typename: 'CompanyTypeNodeEdge', node?: { __typename: 'CompanyTypeNode', id: string, name: string } | null } | null> } | null };


export const CompanyTypesQueryDocument = gql`
...
/**
 * __useCompanyTypesQueryQuery__
 *
 * To run a query within a React component, call `useCompanyTypesQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useCompanyTypesQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCompanyTypesQueryQuery({
 *   variables: {
 *      instanceIds: // value for 'instanceIds'
 *   },
 * });
 */
export function useCompanyTypesQueryQuery(baseOptions: Apollo.QueryHookOptions<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables> & ({ variables: CompanyTypesQueryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables>(CompanyTypesQueryDocument, options);
      }
export function useCompanyTypesQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables>(CompanyTypesQueryDocument, options);
        }
export function useCompanyTypesQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables>(CompanyTypesQueryDocument, options);
        }
export type CompanyTypesQueryQueryHookResult = ReturnType<typeof useCompanyTypesQueryQuery>;
export type CompanyTypesQueryLazyQueryHookResult = ReturnType<typeof useCompanyTypesQueryLazyQuery>;
export type CompanyTypesQuerySuspenseQueryHookResult = ReturnType<typeof useCompanyTypesQuerySuspenseQuery>;
export type CompanyTypesQueryQueryResult = Apollo.QueryResult<CompanyTypesQueryQuery, CompanyTypesQueryQueryVariables>;