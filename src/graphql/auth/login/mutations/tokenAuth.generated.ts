...
export type TokenAuthV2MutationVariables = Types.Exact<{
...
export type TokenAuthV2Mutation = { __typename?: 'Mutation', tokenAuthV2?: { __typename?: 'TokenAuthV2', token?: string | null, success?: boolean | null, fullName?: string | null } | null };


export const TokenAuthV2Document = gql`
    mutation TokenAuthV2($email: String!, $password: String!, $instanceId: ID!) {
  tokenAuthV2(email: $email, password: $password, instanceId: $instanceId) {
    token
    success
    fullName
  }
    ...
    `;
export type TokenAuthV2MutationFn = Apollo.MutationFunction<TokenAuthV2Mutation, TokenAuthV2MutationVariables>;

/**
 * __useTokenAuthV2Mutation__
 *
 * To run a mutation, you first call `useTokenAuthV2Mutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTokenAuthV2Mutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [tokenAuthV2Mutation, { data, loading, error }] = useTokenAuthV2Mutation({
 *   variables: {
 ...
 * });
 */
export function useTokenAuthV2Mutation(baseOptions?: Apollo.MutationHookOptions<TokenAuthV2Mutation, TokenAuthV2MutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<TokenAuthV2Mutation, TokenAuthV2MutationVariables>(TokenAuthV2Document, options);
      }
export type TokenAuthV2MutationHookResult = ReturnType<typeof useTokenAuthV2Mutation>;
export type TokenAuthV2MutationResult = Apollo.MutationResult<TokenAuthV2Mutation>;
export type TokenAuthV2MutationOptions = Apollo.BaseMutationOptions<TokenAuthV2Mutation, TokenAuthV2MutationVariables>;