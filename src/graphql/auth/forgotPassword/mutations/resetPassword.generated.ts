...
export type ResetPasswordMutation = { __typename?: 'Mutation', resetPassword?: { __typename?: 'ResetPasswordPayload', passwordChanged?: boolean | null, validationErrors?: Array<string | null> | null } | null };


export const ResetPasswordDocument = gql`
    mutation ResetPassword($uid: String!, $token: String!, $password: String!, $clientMutationId: String) {
  resetPassword(
    input: {uid: $uid, token: $token, newPassword: $password, clientMutationId: $clientMutationId}
  ) {
    passwordChanged
    validationErrors
  }
