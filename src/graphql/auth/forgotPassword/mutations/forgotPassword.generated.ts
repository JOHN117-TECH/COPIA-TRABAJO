...
export type ForgotPasswordMutationVariables = Types.Exact<{
  ...
  instances: Types.Scalars['ID']['input'];
  lang: Types.Scalars['String']['input'];
}>;


export type ForgotPasswordMutation = { __typename?: 'Mutation', forgotPassword?: { __typename?: 'ForgotPasswordPayload', emailSent?: boolean | null } | null };


export const ForgotPasswordDocument = gql`
    mutation ForgotPassword($email: String!, $url: String!, $instances: ID!, $lang: String!) {
  forgotPassword(
    input: {email: $email, url: $url, instanceId: $instances, lang: $lang}
  ) {
    emailSent
  }
}
