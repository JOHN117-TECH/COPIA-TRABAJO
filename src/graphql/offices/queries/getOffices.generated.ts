...
export type GetOfficesQueryVariables = Types.Exact<{
  orderBy?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;


export type GetOfficesQuery = { __typename?: 'Query', offices?: { __typename?: 'OfficeNodeConnection', edges: Array<{ __typename?: 'OfficeNodeEdge', node?: { __typename?: 'OfficeNode', id: string, name: string, address: string, business?: string | null, latitude: number, longitude: number, phone: string, email: string, allEmails?: Array<string | null> | null, city: { __typename?: 'CityNode', id: string, name: string, region?: { __typename?: 'RegionNode', id: string, name: string } | null, country: { __typename?: 'CountryNode', id: string, name: string } } } | null } | null> } | null };


export const GetOfficesDocument = gql`
    query getOffices($orderBy: String) {
 ...
 * });
 */
export function useGetOfficesQuery(baseOptions?: Apollo.QueryHookOptions<GetOfficesQuery, GetOfficesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOfficesQuery, GetOfficesQueryVariables>(GetOfficesDocument, options);
      }
export function useGetOfficesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOfficesQuery, GetOfficesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOfficesQuery, GetOfficesQueryVariables>(GetOfficesDocument, options);
        }
export function useGetOfficesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOfficesQuery, GetOfficesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetOfficesQuery, GetOfficesQueryVariables>(GetOfficesDocument, options);
        }
...
export type GetOfficesQueryResult = Apollo.QueryResult<GetOfficesQuery, GetOfficesQueryVariables>;