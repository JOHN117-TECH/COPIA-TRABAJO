...
export type NewsletterMutationVariables = Types.Exact<{
...
export type NewsletterMutation = { __typename?: 'Mutation', createEmailSubscriber?: { __typename?: 'CreateEmailSubscriber', success?: boolean | null } | null };


export const NewsletterDocument = gql`
    mutation NEWSLETTER($email: String!, $firstName: String!, $lastName: String!) {
  createEmailSubscriber(email: $email, firstName: $firstName, lastName: $lastName) {
    success
  }
}
    `;
export type NewsletterMutationFn = Apollo.MutationFunction<NewsletterMutation, NewsletterMutationVariables>;
 ...
 * });
 */
export function useNewsletterMutation(baseOptions?: Apollo.MutationHookOptions<NewsletterMutation, NewsletterMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<NewsletterMutation, NewsletterMutationVariables>(NewsletterDocument, options);
      }
export type NewsletterMutationHookResult = ReturnType<typeof useNewsletterMutation>;
export type NewsletterMutationResult = Apollo.MutationResult<NewsletterMutation>;
export type NewsletterMutationOptions = Apollo.BaseMutationOptions<NewsletterMutation, NewsletterMutationVariables>;