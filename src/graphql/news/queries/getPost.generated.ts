...
export type GetPostQuery = { __typename?: 'Query', post?: { __typename?: 'PostNode', id: string, title: string, summary: string, publicationDatetime: any, listingImageThumbSmall?: string | null, content: string } | null };
