...
import { PageInfoFragmentFragmentDoc } from '../../patterns/allPaterns/fragments/pageInfo.fragment.generated';
...
export type PostsQueryQueryVariables = Types.Exact<{
  ...
  instances: Array<Types.InputMaybe<Types.Scalars['ID']['input']>> | Types.InputMaybe<Types.Scalars['ID']['input']>;
}>;


export type PostsQueryQuery = { __typename?: 'Query', posts?: { __typename: 'PostNodeConnection', totalCount?: number | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges: Array<{ __typename: 'PostNodeEdge', node?: { __typename: 'PostNode', id: string, title: string, slug: string, summary: string, tags?: Array<string | null> | null, listingImageThumbSmall?: string | null, instances: { __typename: 'InstanceNodeConnection', edges: Array<{ __typename: 'InstanceNodeEdge', node?: { __typename: 'InstanceNode', id: string, name: string } | null } | null> } } | null } | null> } | null };


export const PostsQueryDocument = gql`
    query PostsQuery($first: Int, $last: Int, $afterCursor: String, $beforeCursor: String, $instances: [ID]!) {
  posts(
    first: $first
    last: $last
    after: $afterCursor
 ...
 * });
 */
export function usePostsQueryQuery(baseOptions: Apollo.QueryHookOptions<PostsQueryQuery, PostsQueryQueryVariables> & ({ variables: PostsQueryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
