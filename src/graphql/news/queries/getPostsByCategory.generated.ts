...
export type PostsByCategoryQueryVariables = Types.Exact<{
  ...
  instances?: Types.InputMaybe<Array<Types.InputMaybe<Types.Scalars['ID']['input']>> | Types.InputMaybe<Types.Scalars['ID']['input']>>;
  category?: Types.InputMaybe<Array<Types.InputMaybe<Types.Scalars['ID']['input']>> | Types.InputMaybe<Types.Scalars['ID']['input']>>;
}>;


export type PostsByCategoryQuery = { __typename?: 'Query', posts?: { __typename?: 'PostNodeConnection', edges: Array<{ __typename?: 'PostNodeEdge', node?: { __typename?: 'PostNode', id: string, title: string, publicationDatetime: any, slug: string, content: string, altText?: string | null, summary: string, tags?: Array<string | null> | null, listingImageThumbSmall?: string | null } | null } | null> } | null };


export const PostsByCategoryDocument = gql`
    query postsByCategory($first: Int, $last: Int, $afterCursor: String, $beforeCursor: String, $instances: [ID], $category: [ID]) {
  posts(
    categories: $category
    first: $first
    last: $last
