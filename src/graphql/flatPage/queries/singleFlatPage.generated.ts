...
export type SingleFlatpageQueryQueryVariables = Types.Exact<{
  slug?: Types.InputMaybe<Types.Scalars['String']['input']>;
  instanceId?: Types.InputMaybe<Types.Scalars['ID']['input']>;
}>;


export type SingleFlatpageQueryQuery = { __typename?: 'Query', flatpage?: { __typename?: 'FlatpageNode', id: string, title: string, content: string } | null };


export const SingleFlatpageQueryDocument = gql`
    query SingleFlatpageQuery($slug: String, $instanceId: ID) {
  flatpage(slug: $slug, instance: $instanceId) {
    id
    title
    content
  }
...
/**
 * __useSingleFlatpageQueryQuery__
 *
 * To run a query within a React component, call `useSingleFlatpageQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useSingleFlatpageQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSingleFlatpageQueryQuery({
 *   variables: {
 *      slug: // value for 'slug'
 ...
 * });
 */
export function useSingleFlatpageQueryQuery(baseOptions?: Apollo.QueryHookOptions<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>(SingleFlatpageQueryDocument, options);
      }
export function useSingleFlatpageQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>(SingleFlatpageQueryDocument, options);
        }
export function useSingleFlatpageQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>(SingleFlatpageQueryDocument, options);
        }
export type SingleFlatpageQueryQueryHookResult = ReturnType<typeof useSingleFlatpageQueryQuery>;
export type SingleFlatpageQueryLazyQueryHookResult = ReturnType<typeof useSingleFlatpageQueryLazyQuery>;
export type SingleFlatpageQuerySuspenseQueryHookResult = ReturnType<typeof useSingleFlatpageQuerySuspenseQuery>;
export type SingleFlatpageQueryQueryResult = Apollo.QueryResult<SingleFlatpageQueryQuery, SingleFlatpageQueryQueryVariables>;