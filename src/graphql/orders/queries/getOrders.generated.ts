...
export type GetordersQueryVariables = Types.Exact<{
  ...
  created?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;


export type GetordersQuery = { __typename?: 'Query', orders?: { __typename?: 'PaginatedOrderType', totalCount?: number | null, results?: Array<{ __typename?: 'OrderNode', id: string, created: any, updated: any, status: Types.OrderStatus, items?: { __typename?: 'OrderItemNodeConnection', edges: Array<{ __typename?: 'OrderItemNodeEdge', node?: { __typename?: 'OrderItemNode', id: string, quantity: number, pattern?: { __typename?: 'ProductNode', code: string, color: string, image?: string | null, pattern: { __typename?: 'PatternNode', name: string, id: string, code: string } } | null, product?: { __typename?: 'ProductNode', code: string, color: string, image?: string | null, pattern: { __typename?: 'PatternNode', id: string, name: string, code: string } } | null } | null } | null> } | null, user: { __typename?: 'UserNode', id: string } } | null> | null } | null };


export const GetordersDocument = gql`
    query getorders($page: Int, $size: Int, $created: String) {
  orders(page: $page, size: $size, createdAfter: $created) {
    totalCount
    results {
      id
      created
