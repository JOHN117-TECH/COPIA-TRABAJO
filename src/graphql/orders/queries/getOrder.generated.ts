...
export type GetOrderQuery = { __typename?: 'Query', order?: { __typename?: 'OrderNode', id: string, status: Types.OrderStatus, notes: string, created: any, updated: any, user: { __typename?: 'UserNode', id: string }, shippingAddress?: { __typename?: 'ShippingAddressNode', id: string, address: string, mainAddress: boolean, source: string, city?: { __typename?: 'CityNode', id: string, name: string, country: { __typename?: 'CountryNode', id: string, name: string } } | null } | null, items?: { __typename?: 'OrderItemNodeConnection', edges: Array<{ __typename?: 'OrderItemNodeEdge', node?: { __typename?: 'OrderItemNode', id: string, pattern?: { __typename?: 'ProductNode', id: string, pattern: { __typename?: 'PatternNode', id: string, name: string, slug: string } } | null, product?: { __typename?: 'ProductNode', id: string, color: string, code: string, pattern: { __typename?: 'PatternNode', id: string, name: string, slug: string } } | null } | null } | null> } | null } | null };
