...
export type CreateContactHubspotMutationVariables = Types.Exact<{
  input: Types.CreateContactHubSpotInput;
}>;


export type CreateContactHubspotMutation = { __typename?: 'Mutation', createContactHubspot?: { __typename: 'CreateContactHubSpotPayload', contact?: { __typename: 'ContactNode', id: string } | null } | null };


export const CreateContactHubspotDocument = gql`
  ...
  createContactHubspot(input: $input) {
    ...
    `;
export type CreateContactHubspotMutationFn = Apollo.MutationFunction<CreateContactHubspotMutation, CreateContactHubspotMutationVariables>;

/**
 * __useCreateContactHubspotMutation__
 *
 * To run a mutation, you first call `useCreateContactHubspotMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateContactHubspotMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createContactHubspotMutation, { data, loading, error }] = useCreateContactHubspotMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateContactHubspotMutation(baseOptions?: Apollo.MutationHookOptions<CreateContactHubspotMutation, CreateContactHubspotMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateContactHubspotMutation, CreateContactHubspotMutationVariables>(CreateContactHubspotDocument, options);
      }
export type CreateContactHubspotMutationHookResult = ReturnType<typeof useCreateContactHubspotMutation>;
export type CreateContactHubspotMutationResult = Apollo.MutationResult<CreateContactHubspotMutation>;
export type CreateContactHubspotMutationOptions = Apollo.BaseMutationOptions<CreateContactHubspotMutation, CreateContactHubspotMutationVariables>;