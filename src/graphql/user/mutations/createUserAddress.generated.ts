...
export type CreateUserAddressMutationVariables = Types.Exact<{
  ...
  addressInfo: Types.Scalars['String']['input'];
  isPrimary: Types.Scalars['Boolean']['input'];
}>;


export type CreateUserAddressMutation = { __typename?: 'Mutation', createUserAddress?: { __typename?: 'CreateUserAddressPayload', address?: { __typename?: 'UserAddressNode', id: string, fullAddress: string, city: string, state: string, country: string, postalCode: string, addressInfo: string, isPrimary: boolean, placeId?: string | null } | null } | null };


export const CreateUserAddressDocument = gql`
    mutation createUserAddress($userId: ID!, $placeId: String!, $instanceId: ID!, $addressInfo: String!, $isPrimary: Boolean!) {
  createUserAddress(
    input: {userId: $userId, placeId: $placeId, instanceId: $instanceId, addressInfo: $addressInfo, isPrimary: $isPrimary}
  ) {
    address {
      id
      fullAddress
