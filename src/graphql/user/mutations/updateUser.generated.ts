...
export type UpdateUserMutationVariables = Types.Exact<{
  input: Types.UpdatePublicProfileInput;
}>;


export type UpdateUserMutation = { __typename?: 'Mutation', updatePublicProfile?: { __typename: 'UpdatePublicProfilePayload', clientMutationId?: string | null } | null };


export const UpdateUserDocument = gql`
    mutation updateUser($input: UpdatePublicProfileInput!) {
