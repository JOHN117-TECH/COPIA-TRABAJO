...
export type MeQuery = { __typename?: 'Query', me?: { __typename: 'UserNode', id: string, email: string, password: string, fullName?: string | null, firstName: string, lastName: string, profile?: { __typename: 'ProfileNode', phone: string, company: string, address: string, zipCode?: string | null, position: string, city?: { __typename: 'CityNode', id: string, name: string, region?: { __typename: 'RegionNode', id: string, name: string } | null, country: { __typename: 'CountryNode', id: string, name: string } } | null, companyType?: { __typename: 'CompanyTypeNode', id: string, name: string } | null } | null } | null };
