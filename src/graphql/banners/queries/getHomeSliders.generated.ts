...
export type HomeSlidersQueryVariables = Types.Exact<{
...
export type HomeSlidersQuery = { __typename?: 'Query', homeSliders?: { __typename: 'HomeSliderNodeConnection', edges: Array<{ __typename: 'HomeSliderNodeEdge', node?: { __typename: 'HomeSliderNode', id: string, title: string, description?: string | null, buttonText: string, imageThumb?: string | null, imagePhone?: string | null, imagePhoneThumb?: string | null, link?: string | null, linkMobile?: string | null, linkTarget: string } | null } | null> } | null };


export const HomeSlidersDocument = gql`
...
/**
 * __useHomeSlidersQuery__
 *
 * To run a query within a React component, call `useHomeSlidersQuery` and pass it any options that fit your needs.
 * When your component renders, `useHomeSlidersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useHomeSlidersQuery(baseOptions: Apollo.QueryHookOptions<HomeSlidersQuery, HomeSlidersQueryVariables> & ({ variables: HomeSlidersQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<HomeSlidersQuery, HomeSlidersQueryVariables>(HomeSlidersDocument, options);
      }
export function useHomeSlidersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<HomeSlidersQuery, HomeSlidersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<HomeSlidersQuery, HomeSlidersQueryVariables>(HomeSlidersDocument, options);
        }
export function useHomeSlidersSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<HomeSlidersQuery, HomeSlidersQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<HomeSlidersQuery, HomeSlidersQueryVariables>(HomeSlidersDocument, options);
        }
export type HomeSlidersQueryHookResult = ReturnType<typeof useHomeSlidersQuery>;
export type HomeSlidersLazyQueryHookResult = ReturnType<typeof useHomeSlidersLazyQuery>;
export type HomeSlidersSuspenseQueryHookResult = ReturnType<typeof useHomeSlidersSuspenseQuery>;
export type HomeSlidersQueryResult = Apollo.QueryResult<HomeSlidersQuery, HomeSlidersQueryVariables>;