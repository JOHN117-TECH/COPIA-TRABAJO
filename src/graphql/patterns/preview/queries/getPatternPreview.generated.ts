...
export type GetPatternPreviewQueryVariables = Types.Exact<{
...
export type GetPatternPreviewQuery = { __typename?: 'Query', pattern?: { __typename: 'PatternNode', code: string, specsSheetData?: any | null, id: string, name: string, altName: string, slug: string, isNew: boolean, products?: { __typename: 'ProductNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'ProductNodeEdge', node?: { __typename: 'ProductNode', id: string, code: string, color: string, predominantColors: Array<string>, imageThumbSmall?: string | null, imageThumbMedium?: string | null, imageThumbLarge?: string | null, isNew: boolean } | null } | null> } | null, sectors: { __typename: 'SectorNodeConnection', edges: Array<{ __typename: 'SectorNodeEdge', node?: { __typename: 'SectorNode', id: string, name: string, market: { __typename: 'MarketNode', id: string, name: string } } | null } | null> } } | null };

export type SinglePatternFragmentFragment = { __typename: 'PatternNode', id: string, name: string, altName: string, slug: string, isNew: boolean };

export const SinglePatternFragmentFragmentDoc = gql`
  ...
  __typename
    ...
    `;
export const GetPatternPreviewDocument = gql`
    query GetPatternPreview($id: ID, $slug: String, $instanceIds: [ID]) {
  pattern(id: $id, slug: $slug) {
    ...
    specsSheetData(fullVersion: false, limitAdditionalTests: true)
    sectors {
      edges {
        node {
          id
...
/**
 * __useGetPatternPreviewQuery__
 *
 * To run a query within a React component, call `useGetPatternPreviewQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPatternPreviewQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPatternPreviewQuery({
 *   variables: {
 *      id: // value for 'id'
 *      slug: // value for 'slug'
 ...
 * });
 */
export function useGetPatternPreviewQuery(baseOptions?: Apollo.QueryHookOptions<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>(GetPatternPreviewDocument, options);
      }
export function useGetPatternPreviewLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>(GetPatternPreviewDocument, options);
        }
export function useGetPatternPreviewSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>(GetPatternPreviewDocument, options);
        }
export type GetPatternPreviewQueryHookResult = ReturnType<typeof useGetPatternPreviewQuery>;
export type GetPatternPreviewLazyQueryHookResult = ReturnType<typeof useGetPatternPreviewLazyQuery>;
export type GetPatternPreviewSuspenseQueryHookResult = ReturnType<typeof useGetPatternPreviewSuspenseQuery>;
export type GetPatternPreviewQueryResult = Apollo.QueryResult<GetPatternPreviewQuery, GetPatternPreviewQueryVariables>;