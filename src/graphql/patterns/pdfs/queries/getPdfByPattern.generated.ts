...
export type PdfPatternQueryQueryVariables = Types.Exact<{
...
export type PdfPatternQueryQuery = { __typename?: 'Query', pattern?: { __typename?: 'PatternNode', pdfUrl?: string | null } | null };


export const PdfPatternQueryDocument = gql`
    query PdfPatternQuery($id: ID, $slug: String, $unitSystem: Int) {
...
/**
 * __usePdfPatternQueryQuery__
 *
 * To run a query within a React component, call `usePdfPatternQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `usePdfPatternQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePdfPatternQueryQuery({
 *   variables: {
 *      id: // value for 'id'
 *      slug: // value for 'slug'
 ...
 * });
 */
export function usePdfPatternQueryQuery(baseOptions?: Apollo.QueryHookOptions<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>(PdfPatternQueryDocument, options);
      }
export function usePdfPatternQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>(PdfPatternQueryDocument, options);
        }
export function usePdfPatternQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>(PdfPatternQueryDocument, options);
        }
export type PdfPatternQueryQueryHookResult = ReturnType<typeof usePdfPatternQueryQuery>;
export type PdfPatternQueryLazyQueryHookResult = ReturnType<typeof usePdfPatternQueryLazyQuery>;
export type PdfPatternQuerySuspenseQueryHookResult = ReturnType<typeof usePdfPatternQuerySuspenseQuery>;
export type PdfPatternQueryQueryResult = Apollo.QueryResult<PdfPatternQueryQuery, PdfPatternQueryQueryVariables>;