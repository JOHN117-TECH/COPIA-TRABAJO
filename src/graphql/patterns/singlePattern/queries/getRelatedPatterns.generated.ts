...
export type GetRelatedPatternsQueryVariables = Types.Exact<{
...
export type GetRelatedPatternsQuery = { __typename?: 'Query', pattern?: { __typename?: 'PatternNode', relatedPatterns?: { __typename: 'PatternNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'PatternNodeEdge', node?: { __typename: 'PatternNode', imageThumbSmall?: string | null, id: string, name: string, altName: string, slug: string, isNew: boolean, sectors: { __typename?: 'SectorNodeConnection', edges: Array<{ __typename?: 'SectorNodeEdge', node?: { __typename?: 'SectorNode', name: string } | null } | null> }, products?: { __typename: 'ProductNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'ProductNodeEdge', node?: { __typename: 'ProductNode', id: string, code: string, color: string, predominantColors: Array<string>, hasStock: boolean, samplesAvailable: boolean, stock: string, pantone?: string | null, imageThumbSmall?: string | null, imageThumbMedium?: string | null, imageThumbLarge?: string | null, isNew: boolean } | null } | null> } | null } | null } | null> } | null } | null };


export const GetRelatedPatternsDocument = gql`
...
/**
 * __useGetRelatedPatternsQuery__
 *
 * To run a query within a React component, call `useGetRelatedPatternsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetRelatedPatternsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetRelatedPatternsQuery({
 *   variables: {
 *      slug: // value for 'slug'
 ...
 * });
 */
export function useGetRelatedPatternsQuery(baseOptions?: Apollo.QueryHookOptions<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>(GetRelatedPatternsDocument, options);
      }
export function useGetRelatedPatternsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>(GetRelatedPatternsDocument, options);
        }
export function useGetRelatedPatternsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>(GetRelatedPatternsDocument, options);
        }
export type GetRelatedPatternsQueryHookResult = ReturnType<typeof useGetRelatedPatternsQuery>;
export type GetRelatedPatternsLazyQueryHookResult = ReturnType<typeof useGetRelatedPatternsLazyQuery>;
export type GetRelatedPatternsSuspenseQueryHookResult = ReturnType<typeof useGetRelatedPatternsSuspenseQuery>;
export type GetRelatedPatternsQueryResult = Apollo.QueryResult<GetRelatedPatternsQuery, GetRelatedPatternsQueryVariables>;