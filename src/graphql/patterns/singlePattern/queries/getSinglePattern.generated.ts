...
import { SinglePatternFragmentFragmentDoc } from '../../preview/queries/getPatternPreview.generated';
import { SinglePatternSustainabilityAttributesFragmentDoc } from '../fragments/singlePatternSustainabilityAttributes.fragment.generated';
import { SinglePatternFragmentDoc } from '../fragments/singlePattern.fragment.generated';
...
export type SinglePatternQueryQueryVariables = Types.Exact<{
  id?: Types.InputMaybe<Types.Scalars['ID']['input']>;
  slug?: Types.InputMaybe<Types.Scalars['String']['input']>;
  unitSystem?: Types.InputMaybe<Types.Scalars['Int']['input']>;
  instanceIds?: Types.InputMaybe<Array<Types.InputMaybe<Types.Scalars['ID']['input']>> | Types.InputMaybe<Types.Scalars['ID']['input']>>;
  instanceId?: Types.InputMaybe<Types.Scalars['ID']['input']>;
}>;


export type SinglePatternQueryQuery = { __typename?: 'Query', pattern?: { __typename: 'PatternNode', hasStock: boolean, cataloguesAvailable: boolean, code: string, maintenanceGuide?: string | null, zippedImagesUrl?: string | null, approvedCleanersPdfUrl?: string | null, transformationGuide?: string | null, catalogStockNumber?: string | null, saleable?: boolean | null, specsSheetData?: any | null, packagingFsc?: boolean | null, id: string, name: string, altName: string, slug: string, isNew: boolean, productcategorization?: { __typename: 'ProductCategorizationNode', design?: any | null } | null, memo?: { __typename: 'MemoNode', id: string, size: string } | null, products?: { __typename: 'ProductNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'ProductNodeEdge', node?: { __typename: 'ProductNode', id: string, code: string, color: string, predominantColors: Array<string>, hasStock: boolean, samplesAvailable: boolean, stock: string, pantone?: string | null, imageThumbSmall?: string | null, imageThumbMedium?: string | null, imageThumbLarge?: string | null, isNew: boolean } | null } | null> } | null, otherattributes?: { __typename: 'OtherAttributesNode', certificateDomain?: string | null } | null, sustainability?: { __typename: 'SustainabilityNode', id: string, biobasedPvcBioAttributed: boolean, phthalateFreeProduct?: string | null, phthalateFreeProductCertificateFile: string, frFree?: string | null, frFreeCertificateFile: string, mpFree?: string | null, mpFreeCertificateFile: string, cytotoxicity?: string | null, cytotoxicityCertificateFile: string, skinSafeSensitization?: string | null, skinSafeSensitizationCertificateFile: string, antimicrobial?: string | null, backingProfile: boolean, backingProfileLogo?: string | null, prop65: boolean, prop65Logo?: string | null, prop65CertificateFile: string, rohs: boolean, rohsLogo?: string | null, rohsCertificateFile: string, reach: boolean, reachLogo?: string | null, reachCertificateFile: string, greenguard: boolean, greenguardLogo?: string | null, greenguardCertificateFile: string, indoorAirQuality: boolean, indoorAirQualityCertificateFile: string, indoorAirQualityLogo?: string | null, globalRecycledStandard: boolean, globalRecycledStandardLogo?: string | null, globalRecycledStandardCertificateFile: string, aPlusEmissions: boolean, aPlusEmissionsLogo?: string | null, aPlusEmissionsCertificateFile: string, epd: boolean, epdCertificateFile: string, leed: boolean, leedLogo?: string | null, well: boolean, wellLogo?: string | null, packagingFscLogo?: string | null } | null, manufacturingCertifications?: Array<{ __typename: 'ManufacturingCertificationsNode', id: string, name: string, logo?: string | null, isSustainable: boolean } | null> | null, sectors: { __typename: 'SectorNodeConnection', edges: Array<{ __typename: 'SectorNodeEdge', node?: { __typename: 'SectorNode', id: string, name: string, market: { __typename: 'MarketNode', id: string, name: string } } | null } | null> }, relatedPatterns?: { __typename: 'PatternNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'PatternNodeEdge', node?: { __typename: 'PatternNode', imageThumbSmall?: string | null, id: string, name: string, altName: string, slug: string, isNew: boolean, products?: { __typename: 'ProductNodeConnection', totalCount?: number | null, edges: Array<{ __typename: 'ProductNodeEdge', node?: { __typename: 'ProductNode', id: string, code: string, color: string, predominantColors: Array<string>, hasStock: boolean, samplesAvailable: boolean, stock: string, pantone?: string | null, imageThumbSmall?: string | null, imageThumbMedium?: string | null, imageThumbLarge?: string | null, isNew: boolean } | null } | null> } | null } | null } | null> } | null, stores: { __typename: 'StoreNodeConnection', totalCount?: number | null } } | null };


export const SinglePatternQueryDocument = gql`
    query SinglePatternQuery($id: ID, $slug: String, $unitSystem: Int, $instanceIds: [ID], $instanceId: ID) {
  pattern(id: $id, slug: $slug) {
    ...
    code
    maintenanceGuide
    zippedImagesUrl(instanceId: $instanceId, hasInstance: true)
    ...
    ${SinglePatternFragmentFragmentDoc}
${SinglePatternSustainabilityAttributesFragmentDoc}
${SinglePatternFragmentDoc}`;

/**
 * __useSinglePatternQueryQuery__
 *
 * To run a query within a React component, call `useSinglePatternQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useSinglePatternQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSinglePatternQueryQuery({
 *   variables: {
 *      id: // value for 'id'
 *      slug: // value for 'slug'
 ...
 * });
 */
export function useSinglePatternQueryQuery(baseOptions?: Apollo.QueryHookOptions<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>(SinglePatternQueryDocument, options);
      }
export function useSinglePatternQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>(SinglePatternQueryDocument, options);
        }
export function useSinglePatternQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>(SinglePatternQueryDocument, options);
        }
export type SinglePatternQueryQueryHookResult = ReturnType<typeof useSinglePatternQueryQuery>;
export type SinglePatternQueryLazyQueryHookResult = ReturnType<typeof useSinglePatternQueryLazyQuery>;
export type SinglePatternQuerySuspenseQueryHookResult = ReturnType<typeof useSinglePatternQuerySuspenseQuery>;
export type SinglePatternQueryQueryResult = Apollo.QueryResult<SinglePatternQueryQuery, SinglePatternQueryQueryVariables>;