...
export type SinglePatternFragment = { __typename: 'PatternNode', id: string, name: string, altName: string, slug: string, isNew: boolean };

export const SinglePatternFragmentDoc = gql`
    fragment SinglePattern on PatternNode {
  id
  name
  altName
  slug
