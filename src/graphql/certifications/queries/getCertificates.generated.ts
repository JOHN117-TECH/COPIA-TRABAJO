...
export type GetCertificatesQueryVariables = Types.Exact<{
  slug?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;


export type GetCertificatesQuery = { __typename?: 'Query', certificates?: { __typename?: 'CertificateNodeConnection', edges: Array<{ __typename?: 'CertificateNodeEdge', node?: { __typename?: 'CertificateNode', id: string, title: string, image?: string | null, imageThumb?: string | null, description: string } | null } | null> } | null };


export const GetCertificatesDocument = gql`
    query getCertificates($slug: String) {
  certificates(domainsUrl: "https://spradling.group", slug: $slug) {
    edges {
      node {
        id
        title
...
export function useGetCertificatesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetCertificatesQuery, GetCertificatesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetCertificatesQuery, GetCertificatesQueryVariables>(GetCertificatesDocument, options);
        }
...
export type GetCertificatesSuspenseQueryHookResult = ReturnType<typeof useGetCertificatesSuspenseQuery>;
